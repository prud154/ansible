...
--BEFORE-FAILOVER
INSERT INTO `movies` VALUES (90,'Pirates of the Caribean 40',' Rob Marshall',2022,1);
INSERT INTO `movies` VALUES (91,'Pirates of the Caribean 40',' Rob Marshall',2022,1);
INSERT INTO `movies` VALUES (92,'Pirates of the Caribean 40',' Rob Marshall',2022,1);
INSERT INTO `movies` VALUES (93,'Pirates of the Caribean 40',' Rob Marshall',2022,1);
...
--AFTER-FAILBACK
INSERT INTO `movies` VALUES (207,'FailBack 30',' Rob Marshall',2018,7);
INSERT INTO `movies` VALUES (208,'FailBack 31',' Rob Marshall',2019,7);
INSERT INTO `movies` VALUES (209,'FailBack 32',' Rob Marshall',2020,7);
INSERT INTO `movies` VALUES (210,'FailBack 33',' Rob Marshall',2021,7);
INSERT INTO `movies` VALUES (211,'FailBack 34',' Rob Marshall',2022,7);
INSERT INTO `movies` VALUES (212,'FailBack 34',' Rob Marshall',2023,7);
INSERT INTO `movies` VALUES (213,'FailBack 36',' Rob Marshall',2024,7);

--DELETING RECORDS--
DELETE from `movies` where movie_id in (100,101,103,104,105);
DELETE from `movies` where movie_id in (2100,2101,2103,2104,2105);
DELETE from `movies` where movie_id in (5000);
DELETE from `movies` where movie_id in (5001);
DELETE from `movies` where movie_id in (5003);
DELETE from `movies` where movie_id in (5004);
DELETE from `movies` where movie_id in (5005);
DELETE from `movies` where movie_id in (6005);
DELETE from `movies` where movie_id in (6000);
DELETE from `movies` where movie_id in (6001);
DELETE from `movies` where movie_id in (6003);
DELETE from `movies` where movie_id in (6004);
...
DELETE FROM `movies` where movie_id in ('103','104','105');
delete from movies where movie_id like '%199%';
delete from movies where movie_id like '%99%';
https://ivanderevianko.com/2019/11/fix-error-code-1175-you-are-using-safe-update-mode


You can't create read replica to this DB instance.
Secrets Manager doesn’t support create read replica feature. To create read replica to this DB instance, you need first to modify this DB instance to turn off the Secrets Manager integration.
